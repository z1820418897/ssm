 ...
 <div class="layui-layout layui-layout-admin">
 	...
 	<div class="layui-header">
 			<a class="layui-logo" href="#">
 				<img src="img/title.png" alt="网页logo" id="title"/>
 			</a>
 		...
 		<div class="layui-side-scroll">
 			<ul class="layui-nav layui-nav-tree" lay-filter="test">
 				<li class="layui-nav-item">
		          ...
		          <dl class="layui-nav-child">
		            <dd><a href="javascript:;"data-id="2" data-title=" 铃眸系列" data-url="cateye"
                               class="site-demo-active" data-type="tabAdd"><i class="layui-icon">&#xe716;</i> 铃眸系列</a></dd>
		          </dl>
		        </li>
		        	
		        <li class="layui-nav-item">
		          <a href="javascript:;"><i class="layui-icon">&#xe653;</i> 版本库管理</a>
		          <dl class="layui-nav-child">
		            <dd><a href="javascript:;"data-id="3" data-title=" App版本" data-url="version"
                               class="site-demo-active" data-type="tabAdd"><i class="layui-icon">&#xe716;</i> App版本</a></dd>
		          </dl>
		        </li>	
